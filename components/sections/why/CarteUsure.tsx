...
// Viz : dent stylisée (émail plus clair = érosion) + chiffre, et une barre
// qui se remplit jusqu'à la valeur (38 %).
  ...
  return (
    <div className="flex w-full flex-col items-center">
      <div className="flex items-center gap-2">
        <svg viewBox="0 0 32 40" className="h-9 w-auto shrink-0" fill="none" aria-hidden>
          <path
        ...
        <CountUp
          ...
          suffix="%"
          active={active}
          className="text-2xl font-extrabold leading-none text-marine"
        />
      </div>
      <div className="mt-2 h-2 w-24 overflow-hidden rounded-full bg-ciel-deep">
        <motion.div
